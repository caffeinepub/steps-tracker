...
export class Backend implements backendInterface {
    ...
    async addSteps(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addSteps(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLast7Days(arg0: bigint): Promise<Array<DayLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLast7Days(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaySteps(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaySteps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
